...
- **Out-of-range alert.** When a buff totem's buff leaves you, you've walked out of its range: a red X pulses beside the row and the voice cue plays once. Works everywhere, dungeons and raids included, since it watches your buffs rather than positions.
